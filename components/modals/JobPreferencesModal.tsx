...
interface JobPreferencesModalProps {
  ...
  setJobPreferences: React.Dispatch<React.SetStateAction<JobPreferences>>;
}
...
const JobPreferencesModal: React.FC<JobPreferencesModalProps> = ({ isOpen, onClose, jobPreferences, setJobPreferences }) => {
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Set Job Preferences">
      <div className="space-y-6">
        ...
        <ComboBox
            ...
            value={prefs.payExpectations}
            onChange={payExpectations => setPrefs(p => ({...p, payExpectations}))}
            options={payOptions}
